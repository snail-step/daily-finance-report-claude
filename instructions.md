...
Save the file as reports/{YYYY-MM-DD}-brief.md.

Git workflow:
- Develop and commit on the current working branch, following the harness's routine git policy.
- After the work is complete, automatically push the result to the default branch (main) — fast-forward / merge the working branch into main and push main. Do this automatically, without asking.
...
- Do NOT create a pull request. Do NOT create a GitHub issue.
