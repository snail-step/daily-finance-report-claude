...
Commit it directly to the default branch (main) and push.

End the commit message with this trailer (on its own line):
Co-Authored-By: Claude <noreply@anthropic.com>

Hard constraints (do NOT violate):
- Use ONLY `git add`, `git commit`, and `git push`.
- Do NOT create a feature branch. Do NOT create a pull request. Do NOT create a GitHub issue.
